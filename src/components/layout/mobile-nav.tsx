        ...
        createPortal(
          <>
            ...
            <div
              role="dialog"
              aria-modal="true"
              className="fixed inset-y-0 left-0 z-[100] w-full max-w-sm bg-background shadow-2xl lg:hidden"
            >
                        ...
                        <li key={category.slug}>
                          ...
                          >
                            {category.icon?.startsWith("http") ? (
                              ...
                              <span className="w-5 shrink-0 text-base text-center">{category.icon}</span>
                            )}
